...
What is left after the page, the repo, and the Index row. The object exists. This is the rest of the ritual.
...
### 1. Your own install, on the phone

The container is already running. Text the line. Finish setup if you have not. Get today's paper as a photo. That is install #1.

If you ever need a clean mint:
